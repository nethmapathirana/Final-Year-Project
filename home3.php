...
<body>
    ...
    <form method="post" action="server3.php">
        ...
        <div class="btn-group">
            <button type="submit" name="quizzes" style="position: relative;">Quizzes</button>
            <button type="submit" name="exams" style="position: relative;">Exams</button>
            <button type="submit" name="chatbot" style="position: relative;">Chatbot</button>
        </div>
